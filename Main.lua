...
local o=hrp:FindFirstChild(n)if o then o:Destroy()end end
...
if godConn then godConn:Disconnect()godConn=nil end end end
...
tStroke.Color=Color3.fromRGB(255,255,255)tStroke.Thickness=1.5
...
TweenService:Create(panels[3],TweenInfo.new(0.3),{CanvasPosition=Vector2.new(0,scrollMap[idx])}):Play()end end
for i,b in ipairs(sbBtns)do
...
if i.UserInputType==Enum.UserInputType.Touch or i.UserInputType==Enum.UserInputType.MouseButton1 then mobileInput[key]=false end end)end
